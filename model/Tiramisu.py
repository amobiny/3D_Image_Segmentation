    ...
    def build_network(self, x):
        ...
        with tf.variable_scope('Tiramisu'):
            ...
            with tf.variable_scope('input'):
                x = conv_3d(x, self.k_size, 48, 'input_layer', batch_norm=False, is_train=self.is_training)
            ...
            with tf.variable_scope('output'):
                ...
                self.logits = BN_Relu_conv_3d(stack, 1, self.conf.num_cls, 'Output_layer', batch_norm=True,
                                              is_train=self.is_training)
