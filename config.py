...
flags.DEFINE_integer('height', 190, 'Network input height size')
flags.DEFINE_integer('width', 190, 'Network input width size')
flags.DEFINE_integer('depth', 20, 'Network input depth size')
